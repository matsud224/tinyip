...
void user_task(intptr_t exinf){
    ...
    */
	...
	LOG("sending...");
	while(true){
		send(s2, buf, sizeof(buf), 0, TIMEOUT_NOTUSE);
		wai_sem(USER_BTNSEM);
	}
}
